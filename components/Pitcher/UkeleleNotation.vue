<template>
  <v-card id="card-pitch-ukele-1" class="pa-0">
      ...
      <div class="fretboard-container">
        <svg :viewBox="`0 0 ${fretboardWidth} ${fretboardHeight}`" class="fretboard" preserveAspectRatio="xMidYMid meet">
          ...
          <g v-for="(string, stringIndex) in strings" :key="'notes-' + stringIndex">
            ...
            <circle :cx="getFretX(0) - 30" :cy="getStringY(stringIndex)" :r="noteRadius" :fill="getNoteColor(string, -1)" :opacity="getNoteOpacity(string, -1)" class="note-circle" />
