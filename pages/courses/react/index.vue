      ...
      <v-container fluid class="py-2 px-4">
        <v-row align="center">
          ...
          <v-col cols="12" md="auto">
            <QuizProgressInfo :current-index="currentQuestionIndex" :total="questions.length" :correct="correctCount"
              :answered="answeredCount" :progress="progressPercent" :score-color="scoreColor" :auto-pass="autoPass"
              :countdown-active="countdownActive" :countdown-progress="countdownProgress"
              :translations="translations" />
            <QuizProgressChips :chips="questionChips" :current-index="currentQuestionIndex" @go-to="GO_TO_QUESTION" />
          </v-col>
          ...
          <v-col cols="12" md="auto">
            <QuizProgressAutoPass :auto-pass="autoPass" :delay="autoPassDelay" :translations="translations"
              @toggle-autopass="SET_AUTO_PASS" @update:delay="SET_AUTO_PASS_DELAY" />
          </v-col>
    ...
    <v-container id="quiz-main" class="pa-4">
      <template v-if="!quizStarted">
        ...
        <div class="text-center mb-6">
          <v-icon large color="primary" class="mb-2">mdi-atom</v-icon>
...
const TRANSLATIONS = {
  en: {
    title: 'React 16 Quiz',
    subtitle: 'Test your React 16 knowledge',
  ...
  es: {
    title: 'React 16 Quiz',
    subtitle: 'Pon a prueba tus conocimientos de React 16',
