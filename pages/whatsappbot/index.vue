      ...
      <v-col cols="12" sm="8" md="6" lg="5">
        <v-card class="bot-card elevation-24 rounded-xl overflow-hidden">
          ...
          <v-card-text class="pa-8">
            <v-form ref="form" v-model="valid" lazy-validation>
              ...
              <v-btn
                ...
                x-large
                color="success"
                class="send-btn rounded-pill font-weight-bold elevation-8"
                :loading="sending"
                :disabled="!valid || botStatus !== 'READY'"
            ...
            <div v-if="botStatus === 'QR_RECEIVED'" class="mt-6 text-center qr-instruction pa-4 rounded-lg">
              ...
              <p class="mb-0 warning--text font-weight-medium">
                ...
                <a :href="baseUrl + '/qr'" target="_blank" class="font-weight-bold">Scan QR Code Here</a>
              </p>
            </div>
          </v-card-text>
          ...
          <v-card-actions class="pa-4 grey lighten-5">
            ...
            <span class="caption grey--text text--darken-1 ml-2">{{ baseUrl }}</span>
            <v-spacer></v-spacer>
...
export default {
  ...
  methods: {
    ...
    async sendWhatsAppMessage() {
      ...
      try {
        const { data } = await axios.post(`${this.baseUrl}/api/send-message`, {
          phone: this.phone,
